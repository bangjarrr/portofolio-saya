                    ...
                    <Col md={8} className="mt-5 img-fluid">
                        <div>
                            <div className="mb-3 project">
                                ...
                                <p>Website Coffee Shop. Show demo <a href="https://kedai-kopi-kita.netlify.app/halaman-utama/" target="_blank" rel="noreferrer" className="text-warning">in here</a>.</p>
                            </div>
                            <div className="mb-3 project">
                                ...
                                <p>Manajemen Perpuskataan with Python. Show demo <a href="https://manajemen-perpustakaan.vercel.app/" target="_blank" rel="noreferrer" className="text-warning">in here</a>.</p>
                            </div>
                            ...
                            {showAll && (
                                <div>
                                    <div className="mb-3 project">
                                        ...
                                        <p>Translate Python GUI. Show demo <a href="https://translate-python.vercel.app/" target="_blank" rel="noreferrer" className="text-warning">in here</a>.</p>
                                    </div>
                                </div>
                            )}
                        </div>
