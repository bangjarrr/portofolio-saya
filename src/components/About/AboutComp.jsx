                        ...
                        <Row className="justify-content-center mt-5">
                            <Col md={8} className="text-start" data-aos="fade-up">
                                <p>
                                    ...
                                    <button className="text-primary bg-transparent border-0 p-0" onClick={() => scrollY('service')}> see my certificate</button>. To get to know me better, you
                                    can connect on my <a href="https://t.me/Njir_18" target="_blank" rel="noreferrer" className="text-primary">Telegram</a> or <a href="https://www.instagram.com/bang_jarrrz/" target="_blank" rel="noreferrer" className="text-primary">Instagram</a> you can also contact me via this page <button className="text-primary bg-transparent border-0 p-0" onClick={() => scrollY('contact')}>Contact</button>.
                                </p>
                            </Col>
                        </Row>
                    </>
                    ...
                    <>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} className="text-start mt-5" data-aos="fade-right">
                                <p>
                                    <a href="/" className="text-primary">Fajar Pages</a> is a website created in December 2023. I made this website as a personal record of what I have done, be it my project or other things.
